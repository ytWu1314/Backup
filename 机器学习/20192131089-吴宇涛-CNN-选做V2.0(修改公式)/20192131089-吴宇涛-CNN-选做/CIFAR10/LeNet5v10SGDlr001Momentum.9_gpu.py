...
root='./CIFAR10data',train=True,transform=transform,download=True)

test_dataset=datasets.CIFAR10(
root='./CIFAR10data',train=False,transform=transform,download=False)
...
fig.savefig('accuracy_plotgpu.png',bbox_inches='tight')
fig.savefig('accuracy_plotgpu.eps',bbox_inches='tight')
fig.savefig('accuracy_plotgpu.pdf',bbox_inches='tight')
