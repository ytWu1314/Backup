...
LunarCalendarWidget::LunarCalendarWidget(QWidget *parent) : QWidget(parent)
{
    ...
    showLunar = true;
    bgImage = "../image/peking_university.png";
...
void LunarCalendarWidget::initWidget()
{
    ...
    btnPrevYear->setIcon(QIcon(":/image/left.ico"));
...
void LunarCalendarWidget::paintEvent(QPaintEvent *)
{
    QPainter p;
    p.begin(this);

    p.drawPixmap(0,0,width(),height(),QPixmap("../peking_university.png"));
    p.end();
}
