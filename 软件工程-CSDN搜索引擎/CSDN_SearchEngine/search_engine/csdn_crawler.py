...
def loginPages():
    ...
    driver = webdriver.Chrome(executable_path='C:/Users/PC_SKY_WYT/AppData/Local/Programs/Python/Python37/chromedriver')
...
class CSDN_Spider(threading.Thread):
    def __init__(self):
        ...
        connection = pymysql.connect(host='127.0.0.1',user='root',password='Wyt666!',database='csdn_crawler',charset='utf8mb4')
