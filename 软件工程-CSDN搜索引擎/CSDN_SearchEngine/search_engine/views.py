...
import os,django
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "search_engine.settings")# project_name 项目名称
django.setup()
...
searcher.search_document('C:/Users/PC_SKY_WYT/Desktop/csdntest/text.txt')
